...
7. [Use-Case Recipes](#use-case-recipes)
   ...
   - [Cognitive Load & ADHD](#cognitive-load--adhd)
...
Skill runs a local server (auto-discovered via mDNS or `lsof`).  All commands work over
...
```jsonc
{
  ...
  "first": {
    "focus": 0.64,       // first-half average
    // ...
  },
  "second": {
    "focus": 0.76,       // second-half average
    // ...
  },
  "trends": {
...
```jsonc
{
  ...
  "nodes": [
    ...
    },
    {
      ...
      "eeg_metrics": {
        "focus": 0.74, "relaxation": 0.38, "engagement": 0.62,
...
Send a native OS notification through the Skill app.
...
PORT = 8375   # use --port to find yours, or read from Skill's mDNS
